...
const IrCheckBoxes = class {
    ...
    render() {
        return (index.h("div", { key: '17b6f7e337c7a2a6dba5c8dfceaa0ed9b6198846' }, this.checkboxes.map((checkbox, index$1) => (index.h("ir-checkbox", { name: index$1.toString(), label: checkbox.text, checked: checkbox.checked || false })))));
    }
};
