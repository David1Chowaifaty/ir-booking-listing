...
const irInterceptor_store = require('./ir-interceptor.store-1c4d0faf.js');
...
const IrHkUnassignedUnits = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ddd8df4bd1a6ff93a2e9074aa274b05c26055791' }, index.h("ir-title", { key: '5bed4be74c97b2d33f786b7fbcccd0d99562d878', class: "title px-1", displayContext: "sidebar", label: !this.user ? 'Assingn Units' : `Assignment for ${this.user.name}` }), index.h("section", { key: '0073ad27f57c8f3dfae5dd6c1866425a73dbd2ad', class: "px-1" }, index.h("table", { key: '6bdb6638fc903e97b17eddb13b28dcd2923a4840' }, index.h("thead", { key: 'd7794acdf7209df305cb03b449f34a0baf53fbf3' }, index.h("th", { key: 'fe40f7c9b97302b4b2dcc222bb9ad32069ff5ec0', class: "sr-only" }, "room name"), index.h("th", { key: '2e1bcb346a3cb60e3c4dbf6a20fe13077ff300fa', class: "sr-only" }, "housekeeper name"), index.h("th", { key: '97217da896abd78647c47915f5c87a394f7db4e9', class: "sr-only" }, "actions")), index.h("tbody", { key: 'a7696f9c592b765f726b50ecd31a11a298553abc' }, this.renderRooms())), index.h("div", { key: 'b12c23b23853f7cf838328bbfb908f944d9e8048', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '17719316f84a7fe4d4081b75612ed0a29111a750', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: 'Cancel' }), index.h("ir-button", { key: '69909c23e8be2b150c460a70b2023dfdfe496bc5', isLoading: irInterceptor_store.isRequestPending('/Manage_Exposed_Assigned_Unit_To_HKM'), onClickHanlder: this.assignUnits.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: 'Confirm' })))));
    }
};
...
const IrHkUser = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0ad9b62cee1f58e84642e03f1eaac848055d6671' }, index.h("ir-title", { key: 'b50e04592729c237cbf142466dc37104568ba451', class: "px-1", displayContext: "sidebar", label: this.isEdit ? locales_store.locales.entries.Lcz_EditHousekeeperProfile : locales_store.locales.entries.Lcz_CreateHousekeeperProfile }), index.h("section", { key: 'c6f6fb95aedbe6b263d5dbf31601861031857b81', class: "px-1" }, index.h("ir-input-text", { key: 'cdec5b1f12c2846154d6208d1382c9bf40281bd2', error: ((_b = (_a = this.errors) === null || _a === void 0 ? void 0 : _a.name) === null || _b === void 0 ? void 0 : _b.length) > 0, label: locales_store.locales.entries.Lcz_Name, placeholder: locales_store.locales.entries.Lcz_Name, onTextChange: e => this.updateUserField('name', e.detail), value: this.userInfo.name, onInputBlur: this.handleBlur.bind(this) }), index.h("ir-phone-input", { key: '75be4bfced1b5f905daabc68f0c9bdce6e93fb82', placeholder: locales_store.locales.entries.Lcz_Mobile, error: ((_d = (_c = this.errors) === null || _c === void 0 ? void 0 : _c.mobile) === null || _d === void 0 ? void 0 : _d.length) > 0, language: this.default_properties.language, token: this.default_properties.token, default_country: calendarData.calendar_data.country.id, phone_prefix: (_e = this.user) === null || _e === void 0 ? void 0 : _e.phone_prefix, label: locales_store.locales.entries.Lcz_Mobile, value: this.userInfo.mobile, onTextChange: e => {
                this.updateUserField('phone_prefix', e.detail.phone_prefix);
                this.updateUserField('mobile', e.detail.mobile);
            } }), index.h("ir-input-text", { key: '19aabb56b2039bdaaa6d083993ed39d5581d0b95', disabled: this.user !== null, label: locales_store.locales.entries.Lcz_Username, placeholder: locales_store.locales.entries.Lcz_Username, value: this.userInfo.username, onTextChange: e => this.updateUserField('username', e.detail) }), index.h("ir-input-text", { key: 'a14de575bea3594140a476a91baae91a762b0390', label: locales_store.locales.entries.Lcz_Password, placeholder: locales_store.locales.entries.Lcz_MinimumCharacter, value: this.userInfo.password, type: "password", error: ((_g = (_f = this.errors) === null || _f === void 0 ? void 0 : _f.password) === null || _g === void 0 ? void 0 : _g.length) > 0, onTextChange: e => this.updateUserField('password', e.detail) }), index.h("ir-input-text", { key: '24c5b674da459c79990412180757f860b60488a8', label: locales_store.locales.entries.Lcz_Note, placeholder: locales_store.locales.entries.Lcz_Note, value: this.userInfo.note, onTextChange: e => this.updateUserField('note', e.detail) }), index.h("div", { key: 'd0182e6e83c436dd500fa54009e002b6d2d5f32a', class: "d-flex flex-column flex-md-row align-items-md-center mt-2 w-100" }, index.h("ir-button", { key: '358dbfa9ca0bd1f15bdb7eaa8c9bfd2ef7329440', onClickHanlder: () => this.closeSideBar.emit(null), class: "flex-fill", btn_styles: "w-100  justify-content-center align-items-center", btn_color: "secondary", text: locales_store.locales.entries.Lcz_Cancel }), index.h("ir-button", { key: '0522d6ae525a360c5ed43a1397acec94c63329f0', isLoading: this.isLoading, onClickHanlder: this.addUser.bind(this), class: "flex-fill ml-md-1", btn_styles: "w-100  justify-content-center align-items-center mt-1 mt-md-0", text: locales_store.locales.entries.Lcz_Save })))));
    }
};
...
const IrPhoneInput = class {
    ...
    render() {
        var _a, _b;
        return (index.h(index.Host, { key: 'b72dc1aa0d5b1c8bab480eab4233e5c39324ed7c' }, index.h("div", { key: '2599ce4763bfb8c80583ba33b98d563e3ada20df', class: "form-group mr-0" }, index.h("div", { key: 'b9793dd38561940f57e50d4345761c465b674b99', class: "input-group row m-0 p-0 position-relative" }, this.label && (index.h("div", { key: '2c57520b21c00a5b99949637b7dba26be2d45afa', class: `input-group-prepend col-3 p-0 text-dark border-none` }, index.h("label", { key: '297f9aa2aa4081eb2161f90ff9f1b4fd69a6be80', class: `input-group-text  border-theme flex-grow-1 text-dark  ` }, this.label))), index.h("div", { key: '8931f67d1f956fe0c69c46ed387f2fd9ccc6b344', class: 'form-control  input-container  flex-fill' + (this.error ? ' is-invalid' : '') }, index.h("button", { key: 'af2fb403fa5812b2e16921de7ec80178591db2ec', onClick: () => (this.isDropdownVisible = !this.isDropdownVisible), class: "dropdown-trigger" }, index.h("img", { key: 'ff30e47f90a1fe8b7d54bb169ceb2b8c89c8e4e8', src: (_a = this.currentCountry) === null || _a === void 0 ? void 0 : _a.flag, class: "flag" }), index.h("svg", { key: 'c32ecc1538f141c052b4113526c8b19843dc1a35', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, index.h("path", { key: '4adbf518bd9f92d91695e8accd0edc68a9538c87', d: "M201.4 342.6c12.5 12.5 32.8 12.5 45.3 0l160-160c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L224 274.7 86.6 137.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l160 160z" }))), index.h("label", { key: '496879e297d3e8c4b1b80d6967315a0aaa99ad76' }, (_b = this.currentCountry) === null || _b === void 0 ? void 0 : _b.phone_prefix), index.h("input", { key: '11c1a83f6577db736d4ae6417b00bb454fe2cd07', type: "text", placeholder: this.placeholder, required: true, value: this.inputValue, disabled: this.disabled, onInput: e => this.handleInputChange(e) })), ' ', this.isDropdownVisible && (index.h("div", { key: '2c72a69fa1e91e9aa33f187e8708a8a9f6dae7f4', class: "ir-dropdown-container" }, index.h("ir-combobox", { key: '01cf889a657a42fc03f01b6f21a4ae5ed366347c', onComboboxValueChange: e => {
