...
const IrCheckbox = /*@__PURE__*/ proxyCustomElement(class IrCheckbox extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'fdd9cd004aeba857c54e696a4db8a92312c1ec53' }, h("button", { key: '9b89e45da62d3eeebe90dbe10d2a2d133f984a08', disabled: this.disabled, name: this.name, onClick: this.handleCheckChange.bind(this), id: this.checkboxId, "data-state": this.currentChecked ? 'checked' : 'unchecked', value: 'on', ref: ref => (this.checkboxRef = ref), type: "button", role: "checkbox", class: "CheckboxRoot" }, this.currentChecked && (h("svg", { key: 'adf2d5f2a27d6bce943bc1e51a41265e5471867a', xmlns: "http://www.w3.org/2000/svg", height: "14", width: "12.25", viewBox: "0 0 448 512" }, h("path", { key: '2bb041c53293f938690a48bce6dd9ecd8d220f98', fill: "currentColor", d: "M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z" })))), h("input", { key: '8035acf22da807f14b003ef7a3d76620f6abe1af', type: "checkbox", "aria-hidden": "true", tabindex: "-1", value: "on", checked: this.currentChecked, class: "checkbox" }), this.label && h("label", { key: '3830e815d08591246a3fbcff1eb71b85f51900ac', htmlFor: this.checkboxId }, this.label)));
    }
