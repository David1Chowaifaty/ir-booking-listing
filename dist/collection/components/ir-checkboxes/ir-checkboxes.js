...
export class IrCheckBoxes {
    ...
    render() {
        return (h("div", { key: '17b6f7e337c7a2a6dba5c8dfceaa0ed9b6198846' }, this.checkboxes.map((checkbox, index) => (h("ir-checkbox", { name: index.toString(), label: checkbox.text, checked: checkbox.checked || false })))));
    }
