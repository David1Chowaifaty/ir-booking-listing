...
import { n as getCurrencySymbol, d as dateToFormattedString, j as getReleaseHoursString } from './utils-607295bf.js';
...
import { t as transformNewBLockedRooms } from './booking-0d861a2a.js';
import { E as EventsService } from './events.service-e58cc055.js';
import { i as isRequestPending, a as interceptor_requests } from './ir-interceptor.store-cab4c266.js';
...
const IglBookProperty = class {
    ...
    render() {
        //console.log('render');
        return (h(Host, { key: 'cdb008aa7c7e45bb2bfc1903b98d539a9d392d58' }, h("div", { key: 'e1a64230f395b7bac0336eeafd805f70deda0e50', class: "background-overlay", onClick: () => this.closeWindow() }), h("div", { key: 'ab07d5edd2423f27c2a2b3755a63d64398343e1a', class: 'sideWindow pb-5 pb-md-0 ' + (this.getCurrentPage('page_block_date') ? 'block-date' : '') }, h("div", { key: '00534327bf9cab6ac84102afc880df3d7cb4f634', class: "card position-sticky mb-0 shadow-none p-0 " }, h("div", { key: 'c16f7fb82bd0a68df34c574990e3a3a3f33352ef', class: "d-flex mt-2 align-items-center justify-content-between  " }, h("h3", { key: '0acccdf71314278653913ddf64eee428f23db64d', class: "card-title text-left pb-1 font-medium-2 px-2 px-md-3" }, this.getCurrentPage('page_block_date') ? this.defaultData.BLOCK_DATES_TITLE : this.defaultData.TITLE), h("ir-icon", { key: 'f71053c1f82657a726e63635e9441f416dcf55a6', class: "close close-icon", onIconClickHandler: () => {
                this.closeWindow();
            } }, h("svg", { key: 'f072f3a028604c35ca3c9cf56d24481c7d06cd26', slot: "icon", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 384 512", height: 20, width: 20 }, h("path", { key: '39fe9d9e54c0a5742d41e309ec31952366abef2e', d: "M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z" }))))), h("div", { key: '164b9a471b66c5e1e31b4ea0d5ad3ef27c6f31b0', class: "px-2 px-md-3" }, this.getCurrentPage('page_one') && (h("igl-booking-overview-page", { key: 'a650e30fa7b8839d3355cec51af59e467a7f870f', initialRoomIds: this.initialRoomIds, defaultDaterange: this.defaultDateRange, class: 'p-0 mb-1', eventType: this.defaultData.event_type, selectedRooms: this.selectedUnits, currency: this.currency, showSplitBookingOption: this.showSplitBookingOption, ratePricingMode: this.ratePricingMode, dateRangeData: this.dateRangeData, bookingData: this.defaultData, adultChildCount: this.adultChildCount, bookedByInfoData: this.bookedByInfoData,
...
const IglBookPropertyHeader = class {
    ...
    render() {
        ...
        return (h(Host, { key: '53bad3114fb51718044fb2624d02727062caa4ac' }, this.isEventType('SPLIT_BOOKING') && this.getSplitBookingList(), showSourceNode && this.getSourceNode(), h("div", { key: 'a3ad4ae8e21a537057ae070846dd0ad5e3e94c30', class: `d-flex flex-column flex-lg-row align-items-lg-center ${showSourceNode ? 'mt-1' : ''}` }, h("fieldset", { key: 'ceb0cc5fd3acc7c3a0cafa184d7018b9911824c7', class: "mt-lg-0  " }, h("igl-date-range", { key: '7d7f1e1d54e4795f8a7b7b4ce62f1f07396cd6c9', dateLabel: locales.entries.Lcz_Dates, minDate: this.isEventType('PLUS_BOOKING') ? hooks().add(-1, 'months').startOf('month').format('YYYY-MM-DD') : this.minDate, disabled: this.isEventType('BAR_BOOKING') || this.isEventType('SPLIT_BOOKING'), defaultData: this.bookingDataDefaultDateRange })), !this.isEventType('EDIT_BOOKING') && this.getAdultChildConstraints()), h("p", { key: 'baab31b3f19fac21909644ba654373c2168bc96f', class: "text-right mt-1 message-label" }, calendar_data.tax_statement)));
    }
};
...
const IrInterceptor = class {
    ...
    render() {
        return (h(Host, { key: '627c50b0affe3d93d9ee01ac7d7bb69acea8343b' }, this.isLoading && (h("div", { key: 'ba09aeb27694c18a20f6f110338d5f32160cab28', class: "loadingScreenContainer" }, h("div", { key: 'bc884744828ebd6dbbd5a821eed9959c7dfc1017', class: "loaderContainer" }, h("span", { key: '8026c6c1c07932dea3c645b882ed9ff702dc45b1', class: "loader" }))))));
    }
};
IrInterceptor.style = IrInterceptorStyle0;

export { IglApplicationInfo as igl_application_info, IglBookProperty as igl_book_property, IglBookPropertyFooter as igl_book_property_footer, IglBookPropertyHeader as igl_book_property_header, IglBookingOverviewPage as igl_booking_overview_page, IglBookingRoomRatePlan as igl_booking_room_rate_plan, IglBookingRooms as igl_booking_rooms, IglPagetwo as igl_pagetwo, IglPropertyBookedBy as igl_property_booked_by, IrInterceptor as ir_interceptor };
