import { r as registerInstance, c as createEvent, h, F as Fragment, g as getElement, H as Host } from './index-5a46d2dc.js';
import { h as hooks } from './moment-a9f4173c.js';
import { b as _formatDate, _ as _formatTime, a as _formatAmount, c as _getDay } from './functions-3834a66c.js';
import { a as axios } from './axios-dbdb94c4.js';
import { B as BookingService } from './booking.service-dd04f0fc.js';
...
import { r as renderTime } from './utils-607295bf.js';
import { f as formatName } from './booking-0d861a2a.js';
...
const IrRoom = class {
    ...
    render() {
        ...
        return (h(Host, { key: '5010e8001aa62501400c5ad8cf641249823eec30', class: "p-1 d-flex m-0" }, h("ir-icon", { key: 'becca87ff9973a7b38393b0fff43f58626bf8d8e', id: "drawer-icon", "data-toggle": "collapse", "data-target": `#roomCollapse-${this.item.identifier.split(' ').join('')}`, "aria-expanded": "false", "aria-controls": "collapseExample", class: "pointer mr-1", onClick: () => {
                this.collapsed = !this.collapsed;
            } }, !this.collapsed ? (h("svg", { slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "20", width: "22.5", viewBox: "0 0 576 512" }, h("path", { fill: "#104064", d: "M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z" }))) : (h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "20", width: "25", viewBox: "0 0 640 512", slot: "icon" }, h("path", { fill: "#104064", d: "M38.8 5.1C28.4-3.1 13.3-1.2 5.1 9.2S-1.2 34.7 9.2 42.9l592 464c10.4 8.2 25.5 6.3 33.7-4.1s6.3-25.5-4.1-33.7L525.6 386.7c39.6-40.6 66.4-86.1 79.9-118.4c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C465.5 68.8 400.8 32 320 32c-68.2 0-125 26.3-169.3 60.8L38.8 5.1zM223.1 149.5C248.6 126.2 282.7 112 320 112c79.5 0 144 64.5 144 144c0 24.9-6.3 48.3-17.4 68.7L408 294.5c8.4-19.3 10.6-41.4 4.8-63.3c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3c0 10.2-2.4 19.8-6.6 28.3l-90.3-70.8zM373 389.9c-16.4 6.5-34.3 10.1-53 10.1c-79.5 0-144-64.5-144-144c0-6.9 .5-13.6 1.4-20.2L83.1 161.5C60.3 191.2 44 220.8 34.5 243.7c-3.3 7.9-3.3 16.7 0 24.6c14.9 35.7 46.2 87.7 93 131.1C174.5 443.2 239.2 480 320 480c47.8 0 89.9-12.9 126.2-32.5L373 389.9z" })))), h("div", { key: 'd7fcef133b9bcafcffcc5ee0b3d77aa92416a016', class: "flex-fill m-0 " }, h("div", { key: '3be1449d34558a8247204c7f95c718c7e0fa52a3', class: "d-flex align-items-start justify-content-between sm-mb-1" }, h("p", { key: '6cecf0a935883abf8a6d509ffb1a0ed05a0697f4', class: "m-0 p-0" }, h("strong", { key: '416846e66f2efc448b33e124363e76c363207131', class: "m-0 p-0" }, this.myRoomTypeFoodCat || '', " "), " ", this.mealCodeName, ' ', this.item.rateplan.is_non_refundable && ` - ${this.defaultTexts.entries.Lcz_NonRefundable}`, ' '), h("div", { key: '6024ba14311533f989d7a3b7d6023649cb23fd20', class: "d-flex m-0 p-0 align-items-center" }, h("span", { key: '610690a962b1496e0e57128ab40e1bd5c3c3b1e2', class: "p-0 m-0 ml-1 font-weight-bold" }, _formatAmount(this.item['gross_total'], this.currency)), this.hasRoomEdit && (h("ir-icon", { key: '18aaade73db2587263477c7d8f12221f549edbc2', id: `roomEdit-${this.item.identifier}`, class: "pointer mx-1", onClick: this.handleEditClick.bind(this) }, h("svg", { key: '4d25007c0e4d2c6db78137333fccd82bb1cb32c6', slot: "icon", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "16", viewBox: "0 0 512 512" }, h("path", { key: '46ecc52f7b9af34b18163fa8da661f90c368c1ca', fill: "#6b6f82", d: "M471.6 21.7c-21.9-21.9-57.3-21.9-79.2 0L362.3 51.7l97.9 97.9 30.1-30.1c21.9-21.9 21.9-57.3 0-79.2L471.6 21.7zm-299.2 220c-6.1 6.1-10.8 13.6-13.5 21.9l-29.6 88.8c-2.9 8.6-.6 18.1 5.8 24.6s15.9 8.7 24.6 5.8l88.8-29.6c8.2-2.7 15.7-7.4 21.9-13.5L437.7 172.3 339.7 74.3 172.4 241.7zM96 64C43 64 0 107 0 160V416c0 53 43 96 96 96H352c53 0 96-43 96-96V320c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V160c0-17.7 14.3-32 32-32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96z" })))), this.hasRoomDelete && (h("ir-icon", { key: '4fce9628411b5398205a06ec854dcfc3152592d5', onClick: this.handleDeleteClick.bind(this), id: `roomDelete-${this.item.identifier}`, class: "pointer" }, h("svg", { key: 'e86d49f41f177277fd6dc4cbc6df910b4ef2c74d', slot: "icon", fill: "#ff2441", xmlns: "http://www.w3.org/2000/svg", height: "16", width: "14.25", viewBox: "0 0 448 512" }, h("path", { key: '60843622633787f8cf1f28d1df49f4383311c71e', d: "M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z" })))))), h("div", { key: 'a3162acfb21653515f0f33c3f9d2e80451b0e031', class: "d-flex align-items-center sm-mb-1" }, h("ir-date-view", { key: 'a51c2b5e488a4bd06e786d0018440aa0a4ca7410', class: "mr-1", from_date: this.item.from_date, to_date: this.item.to_date, showDateDifference: false }), calendar_data.is_frontdesk_enabled && this.item.unit && h("span", { key: 'ee5063c7fa0d59a98bed9d45e7fe2e57421a1877', class: "light-blue-bg mr-2 " }, this.item.unit.name), this.hasCheckIn && h("ir-button", { key: '1329ad08275cf5af76a647a6b9d87a114b37b864', id: "checkin", icon: "", class: "mr-1", btn_color: "info", size: "sm", text: "Check in" }), this.hasCheckOut && h("ir-button", { key: '300fc11fbd88a1d7cffcfbde935adf315c8877c9', id: "checkout", icon: "", btn_color: "info", size: "sm", text: "Check out" })), h("div", { key: 'ea477a4a2643791e9107b7e9ea873dd410329f87' }, h("span", { key: 'dac3f0feda0a09a1b3494b70b9b73c48e407469a', class: "mr-1" }, `${this.item.guest.first_name || ''} ${this.item.guest.last_name || ''}`), this.item.rateplan.selected_variation.adult_nbr > 0 && h("span", { key: '1fc7606e1ccf59214864e751142ecece91908c62' }, " ", this.item.rateplan.selected_variation.adult_child_offering)), h("div", { key: '363e00821f6fc3a73f81dbd4f8d39cf516949cf7', class: "collapse", id: `roomCollapse-${this.item.identifier.split(' ').join('')}` }, h("div", { key: '59a9c79d4a8908b6342affa4194371ea519a12fe', class: "d-flex sm-mb-1 sm-mt-1" }, h("div", { key: '708f25e6bca9ced597b322692c78233c27200b84', class: " sm-padding-top" }, h("strong", { key: '44277993ddaa8d4480aa06adbda21fee03fa3f82', class: "sm-padding-right" }, `${this.defaultTexts.entries.Lcz_Breakdown}:`)), h("div", { key: '0b0806a18d038dfd6f823bbaddcd28a6de303081', class: 'flex-fill' }, h("table", { key: '9d22791aafc01fbd8aad44ecc857dceaa8149948' }, this.item.days.length > 0 &&
            ...
            }), h("tr", { key: '821d84b2d02ed4b481128c0f31c1f09af0519a47' }, h("th", { key: '3d1ed5b2341d41c65d058892625a6b5255cc25d5', class: "text-right pr-2" }, this.defaultTexts.entries.Lcz_SubTotal), h("th", { key: 'ee9b4761e772a7c52669a3699f0dad9b15a520cb', class: "text-right" }, _formatAmount(this.item.total, this.currency)), this.item.gross_cost > 0 && this.item.gross_cost !== null && h("th", { key: '1931b3f62eba582ef4bbe27f5e0830e3be84c9f5', class: "pl-2 text-right night-cost" }, _formatAmount(this.item.cost, this.currency))), this.bookingEvent.is_direct ? (h(Fragment, null, (() => {
...
export { IrBookingDetails as ir_booking_details, IrDialog as ir_dialog, GuestInfo as ir_guest_info, IrPaymentDetails as ir_payment_details, IrPickup as ir_pickup, IrRoom as ir_room };

//# sourceMappingURL=ir-booking-details_6.entry.js.map