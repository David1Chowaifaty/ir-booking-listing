import { r as registerInstance, c as createEvent, h, H as Host } from './index-5a46d2dc.js';
...
const IglTbaCategoryView = class {
    ...
    render() {
        return (h(Host, { key: 'c8d16186629477a4a10a450d89af037611a8838b' }, h("div", { key: '077a6d5a8c633529014eb220a46efef3a81dd970', class: "sectionContainer" }, h("div", { key: '8ac8a947820600567cb6ac600c9059c9b9d41156', class: "font-weight-bold mt-1 font-small-3" }, this.categoriesData[this.categoryId].name), this.getEventView(this.categoryId, this.eventDatas))));
    }
};
